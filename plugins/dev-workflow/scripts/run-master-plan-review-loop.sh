...
# (a) require the master plan to exist
[[ -f "doc/task/master_plan.md" ]] || { echo "ERROR: doc/task/master_plan.md not found" >&2; exit 1; }
...
# (b) build the master-plan manifest
"$ROOT/scripts/build-master-plan-manifest.sh" --force
